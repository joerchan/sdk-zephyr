 ...
 *         often referred to as a B-frame.
...
/** L2CAP SDU length size, used for buffer size calculations */
#define BT_L2CAP_SDU_HDR_SIZE           2

/** @def BT_L2CAP_SDU_BUF_SIZE
 *
 *  @brief Helper to calculate needed buffer size for L2CAP Credit-based frame,
 *         often referred to as a K-frame.
 *         Useful for creating buffer pools.
 *
 *  @param mtu Needed L2CAP MTU.
 *
