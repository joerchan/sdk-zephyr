...
static int gatt_req_send(struct bt_conn *conn, bt_att_func_t func, void *params,
			 bt_att_write_buf_t write_buf, uint8_t op, size_t len)

{
	...
	req = gatt_req_alloc(func, params, write_buf, op, len);
	if (!req) {
		return -ENOMEM;
	}
...
static int gatt_exchange_mtu_write_buf(struct net_buf *buf, size_t len,
				       void *user_data)
{
			 ...
			 struct bt_gatt_exchange_params *params)
{
	...
	return gatt_req_send(conn, gatt_mtu_rsp, params,
			     gatt_exchange_mtu_write_buf, BT_ATT_OP_MTU_REQ,
...
static int gatt_find_type_write_buf(struct net_buf *buf, size_t len,
				    void *user_data)
{
	struct bt_gatt_discover_params *params = user_data;
			  ...
			  struct bt_gatt_discover_params *params)
{
	...
	return gatt_req_send(conn, gatt_find_type_rsp, params,
			     gatt_find_type_write_buf, BT_ATT_OP_FIND_TYPE_REQ,
			     len);
}
...
static int read_included_uuid_write_buf(struct net_buf *buf, size_t len,
				        void *user_data)
{
	struct bt_gatt_discover_params *params = user_data;
			      ...
			      struct bt_gatt_discover_params *params)
{
	...
	return gatt_req_send(conn, read_included_uuid_cb, params,
			     read_included_uuid_write_buf, BT_ATT_OP_READ_REQ,
...
static int gatt_read_type_write_buf(struct net_buf *buf, size_t len,
				    void *user_data)
{
	struct bt_gatt_discover_params *params = user_data;
			  ...
			  struct bt_gatt_discover_params *params)
{
	...
	return gatt_req_send(conn,gatt_read_type_rsp, params,
			     gatt_read_type_write_buf, BT_ATT_OP_READ_TYPE_REQ,
...
static int gatt_read_group_write_buf(struct net_buf *buf, size_t len, void *user_data)
{
	struct bt_gatt_discover_params *params = user_data;
...
static int gatt_find_info_write_buf(struct net_buf *buf, size_t len, void *user_data)
{
	struct bt_gatt_discover_params *params = user_data;
			  ...
			  struct bt_gatt_discover_params *params)
{
	...
	return gatt_req_send(conn, gatt_find_info_rsp, params,
			     gatt_find_info_write_buf, BT_ATT_OP_FIND_INFO_REQ,
...
static int gatt_read_blob_write_buf(struct net_buf *buf, size_t len,
				    void *user_data)
{
	struct bt_gatt_read_params *params = user_data;
			  ...
			  struct bt_gatt_read_params *params)
{
	...
	return gatt_req_send(conn, gatt_read_rsp, params,
			     gatt_read_blob_write_buf, BT_ATT_OP_READ_BLOB_REQ,
			     sizeof(struct bt_att_read_blob_req));
}

static int gatt_read_uuid_write_buf(struct net_buf *buf, size_t len,
				    void *user_data)
{
	struct bt_gatt_read_params *params = user_data;
	struct bt_att_read_type_req *req;
			  ...
			  struct bt_gatt_read_params *params)
{
	...
	return gatt_req_send(conn, gatt_read_rsp, params,
			     gatt_read_uuid_write_buf, BT_ATT_OP_READ_TYPE_REQ,
			     sizeof(struct bt_att_read_type_req));
}
...
static int gatt_read_mult_write_buf(struct net_buf *buf, size_t len,
				     void *user_data)
{
	struct bt_gatt_read_params *params = user_data;
	uint8_t i;
			  ...
			  struct bt_gatt_read_params *params)
{
	...
	return gatt_req_send(conn, gatt_read_mult_rsp, params,
			     gatt_read_mult_write_buf, BT_ATT_OP_READ_MULT_REQ,
...
static int gatt_read_mult_vl_write_buf(struct net_buf *buf, size_t len,
					void *user_data)
{
	struct bt_gatt_read_params *params = user_data;
	uint8_t i;
...
static int gatt_read_write_buf(struct net_buf *buf, size_t len, void *user_data)
{
	struct bt_gatt_read_params *params = user_data;
	struct bt_att_read_req *req;
...
int bt_gatt_read(struct bt_conn *conn, struct bt_gatt_read_params *params)
{
	...
	return gatt_req_send(conn, gatt_read_rsp, params, gatt_read_write_buf,
			     BT_ATT_OP_READ_REQ,
			     sizeof(struct bt_att_read_req));
}
...
static int gatt_exec_write_buf(struct net_buf *buf, size_t len, void *user_data)
{
			   ...
			   struct bt_gatt_write_params *params)
{
	...
	return gatt_req_send(conn, gatt_write_rsp, params, gatt_exec_write_buf,
...
static int gatt_prepare_write_buf(struct net_buf *buf, size_t len,
				  void *user_data)
{
	struct bt_gatt_write_params *params = user_data;
	...
	data = ((uint8_t *)params->data) + params->offset;
	write = net_buf_append_bytes(buf, len - sizeof(*req), data,
				     K_NO_WAIT, NULL, NULL);
			      ...
			      struct bt_gatt_write_params *params)
{
	...
	return gatt_req_send(conn, gatt_prepare_write_rsp, params,
			     gatt_prepare_write_buf,
			     BT_ATT_OP_PREPARE_WRITE_REQ, len);
}

static int gatt_write_buf(struct net_buf *buf, size_t len, void *user_data)
{
	struct bt_gatt_write_params *params = user_data;
...
int bt_gatt_write(struct bt_conn *conn, struct bt_gatt_write_params *params)
{
	...
	return gatt_req_send(conn, gatt_write_rsp, params, gatt_write_buf,
